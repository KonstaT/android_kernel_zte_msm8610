		...
		struct platform_device *pdev, char *panel_cfg)
{
	...
	if (!l) {
		...
		if (!strncmp(panel_name, TXD_ILI9806C_480_800_4P0_P821A10_NAME,strnlen(TXD_ILI9806C_480_800_4P0_P821A10_NAME,PANEL_NAME_MAX_LEN)))
		    ...
		    (!strncmp(panel_name, APEX_HX8379c_480_800_4P0_P821E10_NAME,strnlen(APEX_HX8379c_480_800_4P0_P821E10_NAME,PANEL_NAME_MAX_LEN)))
			LcdPanleID=APEX_HX8379c_480_800_4P0_P821E10; 
		
		
		else if
		    (!strncmp(panel_name, APEX_ILI9806E_480_800_4P0_P821E10_NAME,strnlen(APEX_ILI9806E_480_800_4P0_P821E10_NAME,PANEL_NAME_MAX_LEN)))
